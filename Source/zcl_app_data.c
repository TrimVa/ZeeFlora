...
//{lenght, 'd', 'a', 't', 'a'}
//const uint8 zclApp_ManufacturerName[] = {7, 'p', 'h', 'i', 's', 'c', 'h', 'u'};
//const uint8 zclApp_ModelId[] = {9, 'Z', 'e', 'e', 'F', 'l', 'o', 'w', 'e', 'r'};
const uint8 zclApp_ManufacturerName[] = {8, 'T', 'e', 'c', 'k', '4', 'y', 'o', 'u'};
const uint8 zclApp_ModelId[] = {8, 'Z', 'e', 'e', 'F', 'l', 'o', 'r', 'a'};
