...
static void zclApp_ReadSoilHumidity(void) {
    ...
    uint16 soilHumidityMinRangeAir = 3900;// (uint16)AIR_COMPENSATION_FORMULA(zclBattery_RawAdc);
    uint16 soilHumidityMaxRangeWater = 2900;// (uint16)WATER_COMPENSATION_FORMULA(zclBattery_RawAdc);
